...
async function merge(ele, low, mid, high){
    ...
    for(let i = 0; i < n1; i++){
        ...
        // color
        ele[low + i].style.background = '#e27d60';
    ...
    for(let i = 0; i < n2; i++){
        ...
        // color
        ele[mid + 1 + i].style.background = '#e8a87c';
    ...
    while(i < n1 && j < n2){
        ...
        if(parseInt(left[i]) <= parseInt(right[j])){
            ...
            if((n1 + n2) === ele.length){
                ...
                ele[k].style.background = '#c38d9e';
            }
            
            ele[k].style.height = left[i];
            ele[k].children[0].innerHTML=parseInt(left[i].slice(0, -2))/5
            ...
            ele[k].children[0].innerHTML=parseInt(right[j].slice(0, -2))/5
            j++;
            k++;
        }
    }
